...
namespace AutomationAPI
{
	...
	public:
		...
		HoleCollection* m_holeCollection;
...
AutomationAPI::PartImpl::PartImpl(int guid)
{
	...
	m_holeCollection = new HoleCollection(m_guid);
...
AutomationAPI::HoleCollection* AutomationAPI::PartImpl::Hole()
{

	return m_holeCollection;

}



AutomationAPI::HoleCollection* AutomationAPI::Part::Hole()
{

	return m_partImpl->Hole();
